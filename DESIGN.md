...
The Feature Requirements Fetcher analyzes a specific feature of an existing web application and produces an implementation-ready knowledge base for a separate code-generation service.
